...
import shellStyles from './RequesterSidebarShell.module.css';
  ...
  return (
    <aside className={shellStyles.panel} aria-label="Requester workspace">
      ...
      <div className={shellStyles.content}>
        ...
        {!activeWorkspaceId ? (
          <p className={treeStyles.emptyMessage}>Create a workspace to begin.</p>
        ) : requests.length === 0 ? (
          <p className={treeStyles.emptyMessage}>No requests yet.</p>
        ) : null}
      </div>
